...
MIDDLEWARE = [
    ...
    'hsamp.middleware.CsrfExemptAPIMiddleware',  # Custom CSRF middleware that exempts /api/ endpoints
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'API para plataforma de hiperautomatización de ventas y marketing para logística de carga internacional en Ecuador',
    'VERSION': '1.0.0',
