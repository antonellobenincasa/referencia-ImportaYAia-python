...
export default function ThemeSelector() {
  ...
  return (
    <div ref={dropdownRef} className="relative">
        ...
        <div className="absolute right-0 mt-2 w-72 bg-white rounded-lg shadow-2xl border border-gray-200 py-2 z-50 max-h-96 overflow-y-auto">
          ...
          <div className="border-t border-gray-200 pt-3 pb-2 px-3">
            <button
              ...
              className="w-full inline-flex items-center justify-center gap-2 px-3 py-2 bg-velocity-green text-gray-900 font-semibold rounded-lg hover:opacity-90 transition-opacity text-sm"
            >
      ...
      <CustomThemeCreator isOpen={isCustomizerOpen} onClose={() => setIsCustomizerOpen(false)} />
    </div>
  );
}
